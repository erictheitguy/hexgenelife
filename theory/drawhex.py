import random
from theory.db_connection import get_db_connection, hex_tiles_collection, grass_eater_collection
from tkinter import *
canvas_width = 1000
canvas_height = 1000
...
grass_eater_collection = db.grasseater
scale_factor = 2
search_point_x = 1
search_point_y = 1
...
hex_tiles = hex_tiles_collection.get_all_hex_tiles()
all_mobs = grass_eater_collection.get_all_mobs()
